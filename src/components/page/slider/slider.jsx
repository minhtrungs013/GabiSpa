        ...
        <div className="grid lg:grid-cols-2 place-items-center pt-16 pb-8 md:pt-8">
            ...
            <div>
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-3">
                    <Link to={'/'} className='rounded text-center transition focus-visible:ring-2 ring-offset-2 ring-gray-200 px-5 py-2.5 bg-[#214581] text-white hover:bg-gray-800  border-2 border-transparent flex gap-1 items-center justify-center'>Đăng Ký Ngay</Link>
                    <Link to={'/'} className='rounded text-center transition focus-visible:ring-2 ring-offset-2 ring-gray-200 px-5 py-2.5 bg-white border-2 border-[#214581] hover:bg-gray-100 text-[#214581]  flex gap-1 items-center justify-center'>Dịch Vụ</Link>
                </div>
            </div>
        </div>
    )
